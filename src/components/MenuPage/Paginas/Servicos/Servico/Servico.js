    ...
    return (
        <div className={`card-servico ${getStatusClass(servico.status)}`}>
            <div className="info-esquerda">
                <h4><strong>ID:</strong> {servico.id}</h4>
                <p><strong>Cliente:</strong> {servico.cliente}</p>
                <p><strong>Veículo:</strong> {servico.veiculo}</p>
                <p><strong>Valor total:</strong> R${servico.valorTotal}</p>
                <p><strong>Valor pago:</strong> R${servico.valorPago}</p>
                <p><strong>Data de chegada:</strong> {servico.dataChegada}</p>
                <p><strong>Prev. de término:</strong> {servico.previsaoTermino}</p>
